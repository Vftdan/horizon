...
public class TextButtonLanguageChangeable implements Language.ILanguageChangeable {

	private TextButton elem;
	public String[] keys;
	
	public TextButtonLanguageChangeable(TextButton b, String... k) {
		elem = b;
		keys = k;
	}
